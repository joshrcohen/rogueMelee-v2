...
def options(seed=None, scene=None, encounter=None, special=None, recipient=None):
    ...
    result = dict(seed=seed, scene=scene or ('encounter' if encounter or special else 'progression'), recipient=CHARACTERS.index(recipient), special=0, encounter=0)
    if special:
