...
The verified release patch is `dist/v0.2.0/rogueMelee-v0.2.0.xdelta` (949185 bytes), built from `5ec52a365c75a7846470993c2c37ba6202f877c7`. Its reconstructed image SHA256 is `ec5c3270e3e3ec272dfcc495014483550f19cfb327a1734c528e8d18ca23521d`; release DOL SHA1 is `36601dc8eeee7c24623fdf6303b53e077b85a7ec`. The reconstructed image passed ordinary controller entry/combat/run-end in a fresh profile. All 24 automated tests passed again during packaging. `docs/qa/aerials-release-reconstruction.json` records exact hashes, retained build logs, original-image immutability and preservation of the v0.1.0 patch. The serialized compiler retry matched the independently tested release executable without changing source.
